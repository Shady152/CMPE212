...
public class Vector2 {
	...
	/**
	 * Compares this vector to the specified object. The result is {@code true} if
	 * and only if the argument is not {@code null} and is a {@code Vector2} object
	 * that has the same x and y coordinates as this object.
	 * 
	 * @param obj the object to compare this vector against
	 * @return true if the given object represents a Vector2 object with the same x and y
	 *         coordinates as this vector, false otherwise
	 */
	@Override
