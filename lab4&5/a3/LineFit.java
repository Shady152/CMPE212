...
/**
 * Running the LineFit class should produce a plot of 10 points showing the line of best fit
 *
 */
public class LineFit {
	 ...
	 * squares. The returned array consists of the y-intercept followed by the slope
	 * of the best fit line. If {@code a} is the returned array, then the equation
	 ...
	 * {@code y = 0.0 + x} and the line of the best fit. Prints the slope and
	 * intercept of the best fit line to standard output.
	 * 
	 * @param args not used
	 */
